    ...
    if (loading) {
        return (
            <div className="text-center text-gray-300">
                Loading recruitment drive data...
            </div>
        );
    }
            ...
            <div className="container mx-auto bg-black bg-opacity-70 rounded-lg shadow-lg p-6">
                {recruitmentDrive ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div className="accordion space-y-4">
                                {recruitmentDrive.stages?.map((stage) => (
                                    <div
                                        key={stage.stage_id}
                                        className="border rounded-lg shadow-md p-4 border-[#91919148] cursor-pointer  hover:shadow-lg"
                                    >
                                        <div className="border rounded-lg shadow-md p-4 bg-[radial-gradient(circle,#32343756,black)] border-[#91919148] cursor-pointer  hover:shadow-lg semi-bold">
                                            {stage.stage_name} -{" "}
                                            {stage.stage_type}
                                        </div>
                        ...
                        <div className="border rounded-lg shadow-md p-4 bg-[radial-gradient(circle,#32343756,black)] border-[#91919148] cursor-pointer  hover:shadow-lg items-center justify-center">
                            ...
                            <ul className="space-y-2">
                                ...
                                <li>
                                    ...
                                    {new Date(
                                        recruitmentDrive.start_date * 1000
                                    ).toLocaleDateString()}
                                </li>
                                <li>
                                    <strong>End Date:</strong>{" "}
                                    {new Date(
                                        recruitmentDrive.end_date * 1000
                                    ).toLocaleDateString()}
                                </li>
                                <li>
                                    <strong>Description:</strong>{" "}
                                    {recruitmentDrive.description || "N/A"}
                                </li>
                            </ul>
                            {/* <button
