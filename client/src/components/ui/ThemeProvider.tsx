...
export const themeClasses = {
    ...
    // Text styles
    heading:
        "text-4xl font-bold bg-gradient-to-r from-gradient-purple-start to-gradient-purple-end bg-clip-text text-transparent",
    ...
    // Buttons
    buttonPrimary:
        "px-4 py-2 bg-gradient-to-r from-gradient-purple-start to-gradient-purple-end rounded-xl text-text-primary font-medium hover:shadow-lg transition-all duration-300",
    buttonSecondary:
        "px-4 py-2 border border-border-purple rounded-xl text-text-purple-light hover:bg-background-cardHover transition-all duration-300",
    ...
    // Loading spinner
    spinner:
        "animate-spin rounded-full h-12 w-12 border-b-2 border-primary-purple",
};
...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({ children }) => {
    return <div className={themeClasses.page}>{children}</div>;
};
